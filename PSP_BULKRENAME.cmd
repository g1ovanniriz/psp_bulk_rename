...
if not exist PBP_FILES md PBP_FILES
echo " /$$$$$$$   /$$$$$$  /$$$$$$$        /$$$$$$$            /$$ /$$                                                                            
echo "| $$__  $$ /$$__  $$| $$__  $$      | $$__  $$          | $$| $$                                                                            
echo "| $$  \ $$| $$  \__/| $$  \ $$      | $$  \ $$ /$$   /$$| $$| $$   /$$        /$$$$$$   /$$$$$$  /$$$$$$$   /$$$$$$  /$$$$$$/$$$$   /$$$$$$ "
...
echo "                              get it on https://github.com/g1ovanniriz/psp_bulk_rename                 by t.me/giovanni_riz"
echo.
...
echo Done! The games are located in the PBP_FILES folder. Press any button or close the window to exit.
pause > nul